var lights = Array.prototype.slice.call(document.querySelectorAll('.light-strip'));
var time = document.querySelector('.time')
var best = document.querySelector('.best span');
var bestTime = Number(localStorage.getItem('best')) || Infinity;
var userTime = Number(localStorage.getItem('time')) || Infinity;
var started = false;
var lightsOutTime = 0;
var raf;
var timeout;
...
function end(timeStamp) {
  ...
  if (!lightsOutTime) {
    ...
    console.log('endd', time.textContent)
